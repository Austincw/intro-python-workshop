...
TODO: 
	...
	2. Open the file for writing using a 'with' block. 
	   ...
	   with open(filepath, file_mode) as myfile:
	   		# use myfile in this block

	3. Using a for loop, write each name to the file 'names.txt'. Use the file's write() command to write text to the file.
...
nameList = ["Austin","Danyal", "Paul", "Frank", "Bryce", "Ammo", "Yoni"]

myFile = open("namesList.txt", "w")

with open("namesList.txt", "a") as myFiles:
    myFiles.write('Jason\n')
